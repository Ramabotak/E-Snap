...
if (!empty($keyword)) {
    ...
    $searchQuery = "SELECT * FROM buku WHERE judul LIKE '%$keyword_escaped%' OR penulis LIKE '%$keyword_escaped%'";
    ...
    <section class="hero-section">
        ...
        <div class="hero-overlay">
            <div class="hero-content">
                ...
                <p class="hero-subtitle">SMKN 8 Semarang</p>
            </div>
        </div>
    </section>
                    ...
                    <?php if ($searchResults && mysqli_num_rows($searchResults) > 0): ?>
                        <?php while ($row = mysqli_fetch_assoc($searchResults)): ?>
                            <a href="baca.php?id=<?php echo $row['id_buku']; ?>" class="buku-link">
                                <div class="buku-card">
                                    <img src="cover_buku/<?php echo htmlspecialchars($row['cover_buku']); ?>" 
